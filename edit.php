<?php 
  ...
  $req="SELECT * from login where username='".addslashes($username)."' ";
...
<body style="background-color:#E3F2FD">
  ...
  <div style="margin-top: 10%;" class=texto>
      <center>
  <h1>Your information</h1>
    <form action="update.php" method="post" enctype="multipart/form-data" >
        ...
        <tr>
            ...
            <tr>
                <td><b>Full Name</b></td>
                <td><input type="text" name="fullname" value="<?php echo $et['fullname'] ?>" ></td>
            </tr>

            <tr>
                <td><b>Adress</b></td>
                <td><input type="text" name="adress" value="<?php echo $et['adress'] ?>" ></td>
            </tr>
            
           
            <tr>
                <td><b>Phone Number</b></td>
                <td><input type="text" name="tele" value="<?php echo $et['tele'] ?>" ></td>
            </tr>
            <tr>
                <td><b>Facebook </b></td>
